async function fetchStudentData() {
  ...
  try {
    const url = `https://sheets.googleapis.com/v4/spreadsheets/${SHEET_ID}/values/GE!AE6:AX32?key=${API_KEY}`;
    ...
    if (studentRow) {
      ...
      studentRow.slice(8, 11).forEach((cell, index) => {
        const td = document.createElement('td');
...
studentRow.slice(8, 11).forEach((cell) => {
...
const RANGE = "GE!AM4:AX4";  // The range to fetch data from
