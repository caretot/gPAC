...
// Chart configuration
const xValues = ["CS5a", "CS5b", "LANG", "ACWR", "MISSED"];
const barColors = ["#E4BF58", "#3C9D4E", "#7031AC", "#C94D6D", "#000000"]; // Black color for MISSED

const RANGE = "CS!AY4:BJ4";  // The range to fetch data from
