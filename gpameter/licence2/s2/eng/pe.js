function calculateGPA() {
   ...
   let geofieldCC1 = parseFloat(document.getElementById("geofield-cc1").value);
   ...
   const coefs = [
     2/3, 1, 5/3,   /* math                                                        */
     2, 4/3,   /* fluid + elec                                              */
     22*22/9/3/11, 33*22/9/3/11, 44*22/9/3/11,    /* pe geol                                                    */
     2/3, 2/3, 2/3,   /* soft                                                     */
     0.4, 0.8, 0.8,    /* led                                                   */
     0.25, 0.25, 0.5,    /* fr                                               */
     0.25, 0.25, 0.5,    /* en                                               */
...
if (isNaN(enCC3)) {
  ...
  let advicelang = "";
   ...
   let geofieldGPA = (geofieldCC1 * 4/3) / (4/3);
   let oilgasGPA = (oilgasCC1 * 4/3) / (4/3);
   ...
   let phyGPA = ((fluidGPA*2) + (electronicsGPA*4/3))/(2+4/3);
   let pegeolGPA = (wellGPA*2+geofieldGPA*3+oilgasGPA*4)/(2+3+4)
...
if (phyGPA >= 16){
  ...
  } else if (pegeolGPA <= 15.9999 && pegeolGPA >= 13.5) {
  ...
  } else if (pegeolGPA <= 13.4999999 && pegeolGPA >= 11.5) {
  ...
  } else if (pegeolGPA <= 11.4999999 && pegeolGPA >= 10) {
...
if (((softGPA + ledGPA)/2) >= 16) {
  ...
  if (langGPA >= 16){
   ...
   document.getElementById("geofield").innerHTML = geofieldGPA.toFixed(2);
   document.getElementById("geofieldp").innerHTML = (geofieldGPA/0.2).toFixed(1);
   ...
   document.getElementById("pegeol").innerHTML = pegeolGPA.toFixed(2);
   document.getElementById("pegeolp").innerHTML = (pegeolGPA/0.2).toFixed(1);
