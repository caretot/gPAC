  ...
  const cellMappings = {
    ...
    cgpaaver: 'CS!D163',   // CGPA Average
    gpaaver: 'CS!E163',    // GPA Average
    percaver: 'CS!F163'    // Percentage Average
  };
...
const RANGE = 'CS!B114:I157'; // Range for table data
...
const range = 'YESNO!A2:B20';
const url = `https://sheets.googleapis.com/v4/spreadsheets/${sheetId}/values/${range}?key=${apiKey}`;

const labels = [
  'PARALEL PW', 'PARALEL EXAM', 'CLOUD PW', 'CLOUD EXAM', 'SOFTWARE PW', 'SOFTWARE EXAM', 'OSA PW',
  'OSA MID', 'OSA FINAL', 'MOBILE PW', 'MOBILE EXAM', 'PROB MID', 'PROB FINAL', 'FRENCH ORAL',
  'FRENCH MID', 'FRENCH FINAL', 'AC WRITING 1', 'AC WRITING 2', 'AC WRITING 3'
];
