...
const range = 'YESNO!A2:B15';
const url = `https://sheets.googleapis.com/v4/spreadsheets/${sheetId}/values/${range}?key=${apiKey}`;

const labels = [
  'ML PR EXAM', 'ML EXAM', 'CV PW', 'CV EXAM', 'DATA PROJ', 'DATA PW', 
  'SECURITY PR EXAM', 'SECURITY EXAM', 'MANAG', 'ENTREP', 'MAN&ENT EXAM', 
  'INTERN SUP', 'INTERN DEF', 'INTERN REP'
];
