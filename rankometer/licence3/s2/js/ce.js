  ...
  const cellMappings = {
    maxgpage: 'CE!D149',   // Max GPA (CE)
    date: 'CE!E149',       // Last Modified Date
    examrank: 'CE!F149',   // Exam Rank
    cgpaaver: 'CE!D151',   // CGPA Average
    gpaaver: 'CE!E151',    // GPA Average
    percaver: 'CE!F151'    // Percentage Average
  };
...
const RANGE = 'CE!B106:I145'; // Range for table data
...
const range = 'YESNO!J2:K13';
const url = `https://sheets.googleapis.com/v4/spreadsheets/${sheetId}/values/${range}?key=${apiKey}`;

const labels = [
  'BIOREACTORS', 'CH ENG REP', 'CH ENG PRES', 'CHEM PART', 'CHEM REP', 'CHEM PRES', 
  'MANAG', 'ENTREP', 'MAN&ENT EXAM', 'INTERN SUP', 'INTERN DEF', 'INTERN REP'
];
