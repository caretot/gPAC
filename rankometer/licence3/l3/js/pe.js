  ...
  const cellMappings = {
    maxgpage: 'PE!D97',   // Max GPA (CE)
    date: 'PE!E97',       // Last Modified Date
    examrank: 'PE!F97',   // Exam Rank
    cgpaaver: 'L3PE!D99',   // CGPA Average
    gpaaver: 'L3PE!E99',    // GPA Average
    percaver: 'L3PE!F99'    // Percentage Average
  };
...
const RANGE = 'L3PE!N6:T32'; // Range for table data
