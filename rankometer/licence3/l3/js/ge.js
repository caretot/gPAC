  ...
  const cellMappings = {
    maxgpage: 'GE!D97',   // Max GPA (CE)
    date: 'GE!E97',       // Last Modified Date
    examrank: 'GE!F97',   // Exam Rank
    cgpaaver: 'L3GE!D99',   // CGPA Average
    gpaaver: 'L3GE!E99',    // GPA Average
    percaver: 'L3GE!F99'    // Percentage Average
  };
...
const RANGE = 'L3GE!N6:T32'; // Range for table data
